    ...
    <footer className="bg-white py-16 px-4 border-t border-neutral-100">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="flex gap-6 mb-12">
          <a href="https://www.instagram.com/fbx_oficial/" className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-100 text-neutral-600 hover:bg-lime-400 hover:text-black transition-all">
            <Instagram size={20} />
          </a>
          <a href="https://www.youtube.com/@XadrezBrasiliaEventos" className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-100 text-neutral-600 hover:bg-lime-400 hover:text-black transition-all">
            <Youtube size={20} />
          </a>
        </div>
